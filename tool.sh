...
echo "\033[32;1mAuthor : MRLINKERRORSYSTEM"
echo "\033[37;1mFeat: SELFHACK"
echo "\033[35;1mversion Tools: 2"
echo "\033[35;1mTeam : THCA"
echo "\033[33;1mKontak Me :  6281249281196"
echo "\033[31;1mPlease For Subcribe Youtube:"
echo "\033[92mBERBAGIILMUDANAKALSEHAT" 
echo "\033[36;1mINDONESIACYBERHACK"
echo "\033[34;1m[$]\033[36;1m============================\033[34;1m[$]"
echo ""
echo "\033[32;1mSilahkan Pilih Tools Yang  Kamu pake:)?:"
echo "\033[36;1m"
echo "[===============================================[>"
echo $green "1.> Spam Sms Tokopedia [rusak]"
echo "[===============================================]>"
echo $purple "2.> Spam Sms Telkomnyet[rusak]"
echo "[===============================================]>"
echo $cyan "3.> Spam Sms Matahari Mall[rusak]"
echo "[===============================================]>"
echo $red "4.> Spam Sms HooqTV[rusak]"
echo "[===============================================]>"
echo $white "5.> Spam Sms KFC[rusak]"
echo "[===============================================]>"
echo $green "6.> Spam Sms PHD[rusak]"
echo "[===============================================]>"
echo $purple "7.> Spam Sms Whiskas[rusak]"
echo "[===============================================]>"
echo $cyan "8.> Spam Sms ZiPAY [rusak]"
echo "[===============================================]>"
echo $red "9.> Nyari CC buat Carding [rusak]"
echo "[===============================================]>"
echo $white "10.> Spam Akun Gmail [rusak]"
echo "[===============================================]>"
echo $green "11.> Whois LookUp [rusak]"
echo "[===============================================]>"
echo $purple "12.> Upload Admin Finder [rusak]"
echo "[===============================================]>"
echo $cyan "13.> Script Deface Creator [rusak]"
echo "[===============================================]>"
echo $red "14.> ReConDog Buat Information gathering [rusak]"
echo "[===============================================]>"
echo $white "15.> Admin Login Finder [rusak]"
echo "[===============================================]>"
echo $green "16.> Virus VbugMaker Creator [rusak]"
echo "[===============================================]>"
echo $purple "17.> dowload script deface orang [rusak]"
echo "[===============================================]>"
echo $cyan "18.> Autolike Facebook [rusak]"
echo "[===============================================]>"
echo $red "19.> Facebook Auto_Reaction [rusak]"
echo "[===============================================]>"
echo $white "20.> Bot Komentar Facebook [rusak]"
echo "[===============================================]>"
...
echo "[+]===============================================[+]"
echo "\033[32;1m"
read -p "root@CyberMRLINK👻" bro

if [ $bro = 1 ] || [ $bro = 1 ]
then
clear
figlet "CyberLINK" | lolcat
exit
fi
...
then
clear
toilet -f mono12 -F gay "CyberLINK"
exit
fi
...
then
clear
toilet -f slant -F gay "CyberLINK" 
...
then
clear
toilet -f standard -F gay "CyberLINK" 
echo "\033[33;1muntuk tutorial kunjungi:" "\033[36;1m https://www.youtube.com/channel/UCzsBNe-gFuzvqoZK1IdILXg"
sleep 3
apt update
apt install git
apt install php
...
mv Scan-Website-Admin-Login
cd Scan-Website-Admin-Login
...
clear
echo "\033[34;1m"
cowsay -f kiss.cow "CyberLINK" | lolcat
figlet -f slant CyberLINK
echo "\033[37;1m"
...
then
clear
cowsay -f sheep.cow "CyberLINK" | lolcat
figlet "CyberLINK" | lolcat
sleep 1
exit
fi
...
echo "\033[32;1mauthor: MRLINKERRORSYSTEM"
echo "\033[33;1mTeam: THCA"
echo "\033[34;1mIndonesia Error System"
echo "\033[32;1mJawatimur Blackhat Army"
...
./metasploit.sh
echo "\033[33;1muntuk tutorial penggunaan metasploit kunjungi:" "\033[36;1m https://www.youtube.com/channel/UCzsBNe-gFuzvqoZK1IdILXg"
sleep 5
mv metasploit-framework
...
clear
echo "\033[31;1m"
cowsay ghostbusters.cow "CyberLINK" 
figlet "CyberLINK" | lolcat
apt update && apt upgrade
apt install python2
apt install python
...
clear
figlet "CyberLINK" | lolcat
echo "\033[33;1muntuk tutorial kunjungi:" "\033[36;1mhttps://www.youtube.com/channel/UCzsBNe-gFuzvqoZK1IdILXg"
sleep 3
apt install git
apt install python
apt install python2
...
pkg install git
pkg install curl
git clone https://www.youtube.com/channel/UCzsBNe-gFuzvqoZK1IdILXg
mv SocialFish 
cd SocialFish
pip2 install wget
...
then
clear
toilet -f big -F gay "CyberLINK " | lolcat
sleep 1
...
mv Metasploit_For_Termux
cd Metasploit_For_Termux
...
apt install git
apt Install curl 
cd curl -LO https://raw.githubusercontent.com/Techzindia/Kali-linux_For_Termux/master/Kali-linux-Termux 
...
mv PHP-BackConnector
cd PHP-BackConnector
php bc.php
fi
...
if [ $bro = 0 ] || [ $bro = 00 ]
then
echo "\033[32;1mTeam Hacker Cyber ARMY"
sleep 1
